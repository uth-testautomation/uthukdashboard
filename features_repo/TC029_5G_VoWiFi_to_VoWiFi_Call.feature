Feature: VoWiFi-to-VoWiFi Calling

@5G @5G_Call @VoWiFitoVoWiFiCall @btdemo
Scenario Outline:  When user makes a 5G VoWiFi to VoWiFi Call Test

Given the user wants to execute "5G_VoWiFi_To_VoWiFi_Call" test case
...
Then the user analyze the 5G VoWiFi to VoWiFi Call trace
And then the user validates the VoWiFi to VoWiFi logs
